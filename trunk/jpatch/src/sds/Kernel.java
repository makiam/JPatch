	...
	private static class Tester2 {
		Tester2() {
			...
			for (int i = 0; i < 1000; i++) {
				...
				f0[23][0] =-2; f0[23][1] = 0; f0[23][2] = 0;
				f0[24][0] =-2; f0[24][1] = 1; f0[24][2] = 0;
				run(4, f0, f1, lookupTable, 49);
				run(4, f1, f0, lookupTable, 121);
				run(4, f0, f1, lookupTable, 361);
				run(4, f1, f0, lookupTable, 1225);
				run(4, f0, f1, lookupTable, 4489);
				run(4, f1, f0, lookupTable, 17161);
			}
			...
			final JPanel panel = new JPanel() {
				public void paint(Graphics g) {
					super.paint(g);
					for (int i = 0; i < 17161; i++) {
				
						g.drawOval((int) (mesh[i][0] * 400 + 400), (int) (-mesh[i][1] * 400 + 400), 2, 2);
					}
				}
			};
			frame.add(panel);
