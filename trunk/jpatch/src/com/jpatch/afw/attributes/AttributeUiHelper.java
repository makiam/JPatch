...
//					textField.setBackground(Color.YELLOW);
	...
	public static JComboBox createComboBoxFor(final StateMachine stateMachine) {
		final JComboBox comboBox = new JComboBox(stateMachine.getStates().toArray());
		comboBox.setSelectedItem(stateMachine.getState());
		
		/* create a ChangeListener to update the attribute if the slider was changed */
		comboBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				comboBox.setSelectedItem(stateMachine.setState(comboBox.getSelectedItem()));
			}
		});
...
//	}
	...
	private static boolean verifyTextField(JTextField textField, Attribute attribute) {
		if (attribute instanceof GenericAttr) {
