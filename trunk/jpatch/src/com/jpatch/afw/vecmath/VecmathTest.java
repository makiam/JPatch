...
//		System.out.println(s);
		...
		Point3d rayOrigin = new Point3d(0, 0, 0);
		Vector3d rayDirection = new Vector3d(0, 2, 10);
		Point3d sphereCenter = new Point3d(0, 0, 100);
		double sphereRadius = 10;
		Point3d intersectionPoint = new Point3d();
		System.out.println(Utils3d.raySphereIntersection(rayOrigin, rayDirection, sphereCenter, sphereRadius, intersectionPoint, false) + " " + intersectionPoint);
	}
}
