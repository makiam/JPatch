...
//			box.add(AttributeUiHelper.createTextFieldFor(a));
	...
	protected void addFileSelector(Container c, String name, final GenericAttr<File> attribute, int fileSelectionMode, final String approveButtonText) {
		c.add(new JLabel(name));
		...
		box.add(AttributeUiHelper.createTextFieldFor(name, attribute, 200));
		box.add(Box.createHorizontalStrut(4));
		box.add(button);
		c.add(box);
	}
	
	protected void addTuple(Container c, String name, Tuple2Attr a) {
		c.add(new JLabel(name));
		JComponent box = new ExpandableFormRow();
		box.setOpaque(false);
		
		box.add(AttributeUiHelper.createTextFieldFor("x", a.getXAttr()));
		box.add(AttributeUiHelper.createTextFieldFor("y", a.getYAttr()));
		c.add(box);
...
//		c.add(box);
	...
	protected void addTuple(Container c, String name, Tuple3Attr a) {
		...
		box.add(AttributeUiHelper.createTextFieldFor("x", a.getXAttr()));
		box.add(AttributeUiHelper.createTextFieldFor("y", a.getYAttr()));
		box.add(AttributeUiHelper.createTextFieldFor("z", a.getZAttr()));
		c.add(box);
...
//	protected void addLimit(Container c, final Tuple3 a) {
