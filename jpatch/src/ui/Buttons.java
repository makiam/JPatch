...
//			g.draw(new RoundRectangle2D.Float(left - 3, -3, right - left + 4, height + 6, height + 0, height + 0));
	...
	private void test() {
		...
		JPatchToolBar leftToolBar = new JPatchToolBar();
		JPatchToolBar centerToolBar = new JPatchToolBar();
		JPatchToolBar rightToolBar = new JPatchToolBar();
...
//		configureButton(b6, Type.ROUND_GLASS, Position.RIGHT, buttonWidth, buttonHeight, etchedIcon);
		...
		centerToolBar.add(testComponent);
