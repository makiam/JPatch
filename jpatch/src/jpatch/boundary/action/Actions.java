...
//				actionDescriptor.menuItem.setAction(actionDescriptor.action);
	...
	private void addActions(Map<String, ActionDescriptor> map) {
		...
		actionMap.put("lock x", new ActionDescriptor(new XLockAction()));
		actionMap.put("lock y", new ActionDescriptor(new YLockAction()));
		actionMap.put("lock z", new ActionDescriptor(new ZLockAction()));
		...
		actionMap.put("select points", new ActionDescriptor(new SelectPointsAction()));
		actionMap.put("select bones", new ActionDescriptor(new SelectBonesAction()));
		actionMap.put("lock points", new ActionDescriptor(new LockPointsAction()));
		actionMap.put("lock bones", new ActionDescriptor(new LockBonesAction()));
