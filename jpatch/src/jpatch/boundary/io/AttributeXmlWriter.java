...
public class AttributeXmlWriter {
	...
	public void writeAttribute(PrintStream out, String prefix, Attribute attribute) {
		...
		} else if (attribute instanceof Attribute.Tuple3d) {
			writeAttribute(out, prefix + "\t", ((Attribute.Tuple3d) attribute).x);
			writeAttribute(out, prefix + "\t", ((Attribute.Tuple3d) attribute).y);
			writeAttribute(out, prefix + "\t", ((Attribute.Tuple3d) attribute).z);
	...
	private void writeAttributeTag(PrintStream out, Attribute.Tuple3d attribute) {
