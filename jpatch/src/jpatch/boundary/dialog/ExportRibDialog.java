...
//
//public class ExportRibDialog extends BDialog {
//	
...
//	private BuoyUtils.FileSelector fsFile = new BuoyUtils.FileSelector(settings.ribSettings.strPath + File.separator, "Select file", false, this, settings.ribSettings.strPath);
//	private BComboBox comboMode = BuoyUtils.createComboBox(new String[] { "Triangles", "Quadrilaterals", "Subdivision surface", "Bicubic patches (experimental)"}, settings.ribSettings.iOutputMode);
//	private BSlider sliderTesselationQuality = new BSlider(settings.ribSettings.iSubdivMode,1,4,BSlider.HORIZONTAL);
...
//	
//	public ExportRibDialog() {
//		super("Export RenderMan [.rib] file");
//		setModal(true);
//		setResizable(false);
...
//			if (JPatchUtils.getFileExtension(filename).equals("")) filename += ".rib";
//			
//			File file = new File(fsFile.getText());
//			String dir = file.getParent();
//			if (dir != null) settings.ribSettings.strPath = dir;
//			settings.ribSettings.iOutputMode = comboMode.getSelectedIndex();
//			settings.ribSettings.iSubdivMode = sliderTesselationQuality.getValue();
//			dispose();
//			
//			try {
//				BufferedWriter writer = new BufferedWriter(new FileWriter(file));
//				RibRenderer4 ribExport = new RibRenderer4();
//				ribExport.writeModel(MainFrame.getInstance().getModel(), null, "", 0, writer);
//				writer.close();
