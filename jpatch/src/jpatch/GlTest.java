...
public class GlTest {
	...
	public GlTest() {
		try {
			...
			if (platform == OTHER) {
				...
				//logger.log("Let's see where we can store temporary files:\n");
				//String javaIoTmpdir = properties.getProperty("java.io.tmpdir");
				//logger.log("\tjava.io.tmpdir:\t" + javaIoTmpdir + "\n");
				//logger.log("\n");
				//
				//String javaLibraryPath = properties.getProperty("java.library.path");
				//logger.log("\tjava.library.path:\t" + javaLibraryPath + "\n");
				//logger.log("\n");
				//
				//properties.setProperty("java.library.path", javaIoTmpdir);
				//
				//String javaHome = properties.getProperty("java.home");
				//logger.log("\tjava.home:\t" + javaHome + "\n");
				//logger.log("\n");
				//
				//extractJoglLibraries(platform, javaIoTmpdir);
				logger.log("\n");
	...
	//	logger.log("Loading shared library " + file.toString() + "\n");
