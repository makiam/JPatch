/*
 * $Id: JoglInstall.java,v 1.4 2006/05/22 10:46:19 sascha_l Exp $
 *
...
//			break;
	...
	public static String chooseLocation(String[] locations) {
		...
		if(JOptionPane.showConfirmDialog(MainFrame.getInstance(), panel, "JOGL shared libraries installation", JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE) == JOptionPane.OK_OPTION)
