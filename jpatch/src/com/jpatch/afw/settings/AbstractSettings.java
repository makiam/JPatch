/*
 * $Id: AbstractSettings.java 422 2007-03-07 17:08:08Z sascha_l $
 *
...
public abstract class AbstractSettings implements TreeNode {
	...
	public static final Preferences JPATCH_ROOT_NODE = Preferences.userRoot().node(Configuration.getInstance().getString("settingsUserRoot"));
